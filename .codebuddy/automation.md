...
> **版本**: v4.2 (2026-08-13 · 更新频率调整为每 4 天一次 + B1/B2 阅读题难度要求)
...
### 6.7.1 B1/B2 阅读题难度要求（v4.2 新增）
- **B1/B2 每篇各 8 题，合计 16 题，至少保证 4/16 的难题率**（即难题占比 ≥25%）
...
*最后更新：2026-08-13 · 更新频率调整为每 4 天一次 + B1/B2 阅读题难度要求（v4.2）· 基于 11 期实际运行 + Quiz 持久化与云同步 + 期号连续性/HTML 内联安全经验总结*
