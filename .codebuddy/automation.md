...
> **版本**: v4.3 (2026-08-16 · B1/B2 段落数量提升 + B2 难题占比提升 + 难词分析细化)
...
*最后更新：2026-08-16 · v4.3：B1 段落数提升至 ≥18 段、B2 段落数提升至 ≥20 段、B2 难题占比提升至 4/8（50%）、B1/B2 难词分析细化（增加 ejemplo + analisis 字段）· 基于 v4.2 演进*
