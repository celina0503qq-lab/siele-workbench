window.__REFINE_DATE__ = "2026-08-20";
window.WORDS = [
  {
    lema: "viajar",
    ipa: "[bjaˈxaɾ]",
    pos: "v.",
    significado: "旅行；出行（从一个地方到另一个地方）",
    ejemplo_es: "Este verano muchas familias van a viajar a la costa para escapar del calor.",
    ejemplo_zh: "今年夏天许多家庭将去海边旅行，以躲避炎热。",
    tip: "<b>viajar</b> = 旅行。<b>viaje</b> (m.) = 旅行（名词）。<b>viajar en avión/tren/coche</b> = 坐飞机/火车/汽车旅行。A1 日常生活核心动词。"
  },
  {
    lema: "hacer la maleta",
    ipa: "[aˈθeɾ la maˈle.ta]",
    pos: "loc. v.",
    significado: "收拾行李（为旅行整理箱子）",
    ejemplo_es: "Antes de salir de vacaciones, Marta hace la maleta con mucha calma.",
    ejemplo_zh: "度假出发前，玛尔塔从容地收拾行李。",
    tip: "<b>hacer la maleta</b> = 收拾行李。<b>maleta</b> (f.) = 行李箱。<b>equipaje</b> (m.) = 行李。<b>hacer las maletas</b>（复数）= 打包行李。A1 旅行场景高频短语。"
  },
  {
    lema: "fiesta",
    ipa: "[ˈfjes.ta]",
    ...
    ejemplo_es: "En agosto, muchas ciudades españolas celebran sus fiestas más importantes.",
    ejemplo_zh: "八月，许多西班牙城市庆祝它们最重要的节日。",
    tip: "<b>fiesta</b> = 节日/聚会。<b>fiesta mayor</b> = 主节。<b>estar de fiesta</b> = 在过节。<b>feria</b> = 集市/庙会。A2 文化话题核心词。"
  },
  {
    lema: "celebrar",
    ipa: "[θe.leˈβɾaɾ]",
    pos: "v.",
    significado: "庆祝；举办（举行庆祝活动）",
    ejemplo_es: "La ciudad celebra su Semana Grande con conciertos, fuegos artificiales y juegos tradicionales.",
    ejemplo_zh: "这座城市以音乐会、烟花和传统游戏来庆祝它的\"大周\"。",
    tip: "<b>celebrar</b> = 庆祝。<b>celebración</b> (f.) = 庆祝活动。<b>celebrar una fiesta</b> = 举办聚会。<b>festividad</b> = 节日。A2 高频动词。"
  },
  {
    lema: "energía renovable",
    ipa: "[e.neɾˈxi.a re.noˈβa.βle]",
    pos: "f.",
    significado: "可再生能源（太阳能、风能等可再生的能源）",
    ejemplo_es: "España apuesta cada vez más por la energía renovable para reducir su dependencia de los combustibles fósiles.",
    ejemplo_zh: "西班牙越来越重视可再生能源，以减少对化石燃料的依赖。",
    tip: "<b>energía renovable</b> = 可再生能源。<b>energía solar/eólica</b> = 太阳能/风能。<b>renovable</b> = 可再生的。<b>combustible fósil</b> = 化石燃料。B1 科技/环境核心词汇。"
  },
  {
    lema: "almacenamiento",
    ipa: "[al.ma.θe.naˈmjen.to]",
    pos: "m.",
    significado: "储存；蓄能（能源或物品的储存）",
    ejemplo_es: "El almacenamiento de energía es clave para aprovechar la electricidad solar cuando no hay sol.",
    ejemplo_zh: "储能是充分利用太阳能（在没有阳光时也能用电）的关键。",
    tip: "<b>almacenamiento</b> = 储存/蓄能。<b>almacenar</b> = 储存。<b>almacén</b> (m.) = 仓库。<b>batería</b> = 电池。B1 能源转型高频词。"
  },
  {
    lema: "subvención",
    ipa: "[suβ.βenˈθjon]",
    pos: "f.",
    significado: "补贴；补助（政府或机构提供的资金支持）",
    ejemplo_es: "El Gobierno ha concedido subvenciones de más de 400 millones de euros a proyectos de energía limpia.",
    ejemplo_zh: "政府已向清洁能源项目发放了超过 4 亿欧元的补贴。",
    tip: "<b>subvención</b> = 补贴。<b>subvencionar</b> = 资助。<b>ayuda pública</b> = 公共补助。<b>beca</b> = 奖学金（专用于学业）。B1 经济议题高频词。"
  },
  {
    lema: "autoconsumo",
    ipa: "[au̯.to.konˈsu.mo]",
    pos: "m.",
    significado: "自用；自发自用（自己生产并消费能源）",
    ejemplo_es: "El autoconsumo fotovoltaico permite a las familias generar su propia electricidad y ahorrar en la factura.",
    ejemplo_zh: "光伏自用让家庭能够自己发电，从而节省电费。",
    tip: "<b>autoconsumo</b> = 自发自用。<b>auto-</b> 前缀 = 自己。<b>consumo</b> = 消费。<b>autoconsumo colectivo</b> = 集体自用。B1 能源议题专业词。"
  },
  {
    lema: "central nuclear",
    ipa: "[θenˈtɾal nuˈkle.aɾ]",
    pos: "f.",
    significado: "核电站（利用核能发电的设施）",
    ejemplo_es: "El Gobierno ha decidido prolongar la vida de la central nuclear de Almaraz hasta 2030.",
    ejemplo_zh: "政府已决定将阿尔马拉斯核电站的运营寿命延长至 2030 年。",
    tip: "<b>central nuclear</b> = 核电站。<b>central</b> (f.) = 电站/发电厂。<b>nuclear</b> = 核的。<b>reactor</b> (m.) = 反应堆。B2 能源争议话题核心词。"
  },
  {
    lema: "prórroga",
    ipa: "[ˈpɾo.ro.ɣa]",
    pos: "f.",
    significado: "延期；展期（延长某个期限）",
    ejemplo_es: "La prórroga de la vida útil de la central ha generado un intenso debate político.",
    ejemplo_zh: "核电站使用寿命的延期引发了激烈的政治辩论。",
    tip: "<b>prórroga</b> = 延期。<b>prorrogar</b> = 延长。<b>ampliación</b> = 扩大/延期。<b>plazo</b> (m.) = 期限。B2 正式语体高频词。"
  },
  {
    lema: "descarbonización",
    ipa: "[des.kaɾ.βo.ni.θaˈθjon]",
    pos: "f.",
    significado: "脱碳（减少或消除碳排放的过程）",
    ejemplo_es: "La descarbonización de la economía es uno de los grandes objetivos de la Unión Europea.",
    ejemplo_zh: "经济脱碳是欧盟的重大目标之一。",
    tip: "<b>descarbonización</b> = 脱碳。<b>des-</b> 前缀 = 去除。<b>carbono</b> = 碳。<b>emisiones de CO₂</b> = 二氧化碳排放。B2 学术/环境词汇。"
  },
  {
    lema: "apagón",
    ipa: "[a.paˈɣon]",
    pos: "m.",
    significado: "停电；大停电（电力供应中断）",
    ejemplo_es: "El apagón masivo del año pasado reabrió el debate sobre la seguridad del sistema eléctrico.",
    ejemplo_zh: "去年的大规模停电重新引发了关于电力系统安全的辩论。",
    tip: "<b>apagón</b> = 停电。<b>apagar</b> = 关掉。<b>corte de luz</b> = 断电。<b>suministro eléctrico</b> = 电力供应。B2 时事高频词。"
  },
  {
    lema: "exposición",
    ipa: "[eks.po.siˈθjon]",
    pos: "f.",
    significado: "暴露；风险敞口（面临某种风险的程度）",
    ejemplo_es: "La extensión de Almaraz reduce la exposición del sistema eléctrico a las subidas de precio.",
    ejemplo_zh: "阿尔马拉斯核电站的延期降低了电力系统面临价格飙升的风险敞口。",
    tip: "<b>exposición</b> 一词多义：暴露/风险敞口/展览。<b>exponer</b> = 暴露/展示。<b>exponerse a</b> = 暴露于。<b>riesgo</b> = 风险。B2 一词多义考点。"
  },
  {
    lema: "coalición",
    ipa: "[ko.a.liˈθjon]",
    pos: "f.",
    significado: "联盟；联合政府（政党组成的联合体）",
    ejemplo_es: "El socio menor de la coalición de Gobierno criticó duramente la decisión.",
    ejemplo_zh: "执政联盟中的小党严厉批评了这一决定。",
    tip: "<b>coalición</b> = 联盟/联合政府。<b>coalición de Gobierno</b> = 执政联盟。<b>socio</b> = 伙伴/盟党。<b>partido</b> = 政党。B2 政治语汇。"
  },
  {
    lema: "viabilidad",
    ipa: "[bja.βi.liˈðað]",
    pos: "f.",
    significado: "可行性；可持续性（能否实现或维持）",
    ejemplo_es: "Los expertos debaten sobre la viabilidad económica de prolongar las centrales nucleares.",
    ejemplo_zh: "专家们正在争论延长核电站运行的经济可行性。",
...
window.ARTICLES = {
  ...
  b2: {
    paragraphs: [
      { es: "La decisión del Gobierno español de prolongar la vida de la central nuclear de Almaraz ha reabierto un viejo debate: ¿cuál es el papel de la energía nuclear en la transición energética?", zh: "西班牙政府决定延长阿尔马拉斯核电站的使用寿命，重新引发了一场旧有的争论：核能在能源转型中究竟应扮演什么角色？" },
      { es: "Almaraz, situada en la región occidental de Extremadura, estaba prevista para cerrar en 2028, dentro del plan oficial de apagar todos los reactores nucleares en 2035.", zh: "位于西部埃斯特雷马杜拉地区的阿尔马拉斯核电站，原定于 2028 年关闭，这是到 2035 年关停所有核反应堆的官方计划的一部分。" },
      { es: "Sin embargo, las tres empresas propietarias de la central — Iberdrola, Endesa y Naturgy — pidieron al Gobierno mantenerla en funcionamiento dos años más.", zh: "然而，该核电站的三家业主公司——伊维尔德罗拉、恩德萨和纳图尔吉——请求政府让其再运行两年。" },
      { es: "El año pasado, un apagón masivo sin precedentes y la subida de los precios de la energía causada por la guerra en Oriente Medio reavivaron el debate sobre el cierre nuclear.", zh: "去年，一场史无前例的大规模停电，以及中东战争引发的能源价格上涨，重新点燃了关于核电关停的辩论。" },
      { es: "Finalmente, una orden ministerial publicada el miércoles autorizó la prórroga de Almaraz hasta el 8 de junio de 2030.", zh: "最终，周三公布的一项部长令批准将阿尔马拉斯核电站延期至 2030 年 6 月 8 日。" },
      { es: "En el texto oficial, el Gobierno justificó la medida asegurando que \u201Cla prórroga limitada... mitiga la exposición del sistema eléctrico y de los consumidores a subidas de precios imprevistas\u201D.", zh: "在官方文件中，政府为这一措施辩解，称\u201C有限的延期……减轻了电力系统和消费者面临不可预见的电价上涨的风险敞口\u201D。" },
      { es: "El Ejecutivo insistió en que las renovables y el almacenamiento seguirán siendo \u201Clas soluciones estructurales\u201D frente a la dependencia de los combustibles fósiles.", zh: "政府坚称，可再生能源和储能仍将是应对化石燃料依赖的\u201C结构性解决方案\u201D。" },
      { es: "También aseguró que la extensión \u201Ctiene un impacto muy limitado\u201D en la política energética y \u201Cno altera el resto del calendario\u201D, incluida la eliminación total de la energía nuclear en 2035.", zh: "政府还保证，这次延期对能源政策\u201C影响非常有限\u201D，且\u201C不会改变其余时间表\u201D，包括 2035 年彻底淘汰核电。" },
      { es: "Sin embargo, la decisión no ha sido bien recibida por todos. Sumar, el socio menor de la coalición de Gobierno, la criticó con dureza.", zh: "然而，这一决定并未得到所有人的认可。执政联盟中的小党\u201C苏马尔\u201D对其进行了严厉批评。" },
      { es: "Sumar calificó la decisión de basarse en \u201Cpresión empresarial\u201D y no en \u201Cnecesidades técnicas y ambientales o en la competitividad económica\u201D.", zh: "苏马尔党指责该决定是基于\u201C企业施压\u201D，而非\u201C技术和环境需求或经济竞争力\u201D。" },
      { es: "En un comunicado, Sumar afirmó que \u201Cseguir superando la vida útil de esta infraestructura retrasa la descarbonización real basada en renovables e impone costes y riesgos inaceptables a la sociedad\u201D.", zh: "在一份声明中，苏马尔党表示\u201C继续超期运行这一基础设施，会推迟基于可再生能源的真正脱碳，并给社会带来不可接受的成本和风险\u201D。" },
      { es: "También sostuvo que la medida \u201Cencarece el precio de la energía\u201D, contradiciendo así el principal argumento del Gobierno.", zh: "该党还认为，这一措施\u201C推高了能源价格\u201D，从而与政府的主要论点相矛盾。" },
      { es: "El Gobierno, por su parte, había advertido previamente que cualquier prórroga dependería de que la central cumpliera todos los estándares de seguridad y no impusiera costes adicionales a los contribuyentes.", zh: "政府方面此前曾警告说，任何延期都将取决于该核电站是否满足所有安全标准，且不给纳税人带来额外成本。" },
      { es: "La central de Almaraz aporta alrededor del 7% de la producción eléctrica de España y es una fuente clave de industria y empleo en la Extremadura rural y despoblada.", zh: "阿尔马拉斯核电站贡献了西班牙约 7% 的电力生产，是人口稀少的埃斯特雷马杜拉农村地区重要的产业和就业来源。" },
      { es: "La presidenta regional, María Guardiola, celebró la decisión en las redes sociales, calificándola de \u201Cuna decisión que aporta certeza\u201D y que protege \u201Cuna actividad esencial para la vida de tantos pueblos y familias\u201D.", zh: "该地区领导人玛丽亚·瓜迪奥拉在社交媒体上对这一决定表示欢迎，称这是\u201C一项带来确定性的决定\u201D，并保护了\u201C对众多村镇和家庭生活至关重要的产业\u201D。" },
      { es: "El caso español refleja un giro más amplio en Europa, donde varios países están reevaluando el cierre de sus centrales nucleares ante la crisis energética.", zh: "西班牙的这一案例反映了欧洲更广泛的转向：在能源危机面前，多个国家正在重新评估其核电站的关停计划。" },
      { es: "Los defensores de la prórroga argumentan que la energía nuclear ofrece una base estable y libre de emisiones, esencial mientras las renovables maduran.", zh: "延期的支持者认为，核能提供了一种稳定且零排放的基础负荷，这在可再生能源成熟之前至关重要。" },
      { es: "Los críticos, en cambio, advierten que prolongar las centrales retrasa la inversión en renovables y mantiene vivos los riesgos de seguridad y de residuos radiactivos.", zh: "相反，批评者警告说，延长核电站运行会推迟对可再生能源的投资，并使安全风险和放射性废料问题持续存在。" },
      { es: "El equilibrio entre seguridad energética, descarbonización y viabilidad económica se ha convertido en uno de los dilemas más complejos de la política europea contemporánea.", zh: "能源安全、脱碳与经济可行性之间的平衡，已成为当代欧洲政治中最复杂的难题之一。" },
      { es: "La prórroga de Almaraz es, en el fondo, una prueba de si es posible combinar la urgencia climática con la necesidad de mantener un suministro eléctrico estable y asequible.", zh: "从本质上说，阿尔马拉斯核电站的延期是一场考验：能否将气候紧迫性与维持稳定且可负担的电力供应的需求结合起来。" }
    ],
    dele: "B2 考点：<b>虚拟式与条件式的综合运用</b>（si es posible combinar...; dependería de que la central cumpliera）。<b>被动与无人称</b>（estaba prevista, fue publicada, se ha convertido）。<b>间接引语与官方引语</b>（el Gobierno justificó... asegurando que; Sumar afirmó que...）。<b>让步与转折连词</b>（sin embargo, en cambio, por su parte）。<b>动词短语</b>（reavivar el debate, imponer costes, retrasar la descarbonización）。<b>正式学术语体</b>（viabilidad, exposición, descarbonización, prórroga）。<b>观点辨析</b>（政府 vs Sumar vs 地区领导人 vs 企业）。<b>复杂复合句</b>（关系从句 + 目的从句 + 条件从句叠加）。",
    hardWords: [
      { w: "prórroga", m: "延期；展期", ejemplo: "una orden ministerial... autorizó la prórroga de Almaraz hasta el 8 de junio de 2030.", analisis: "源自拉丁语 prorogare（延长），由 pro-（向前）+ rogare（请求）构成，本义\u201C请求延期\u201D。常见搭配 prórroga de un contrato（合同延期）、solicitar una prórroga（申请延期）、conceder una prórroga（批准延期）。语法上为阴性名词。语境义：本文特指核电站\u201C运行寿命的延长\u201D。DELE B2 常考查其与 ampliación（扩大/延期）、extensión（延长）在正式语体中的细微差别：prórroga 更侧重\u201C在期限届满前的续期\u201D。" },
      { w: "exposición", m: "暴露；风险敞口", ejemplo: "mitiga la exposición del sistema eléctrico y de los consumidores a subidas de precios.", analisis: "源自拉丁语 expositio，由 ex-（向外）+ ponere（放置）构成，本义\u201C摆出、暴露\u201D。一词多义：①暴露（exposición al sol 日晒）②风险敞口（exposición al riesgo 风险敞口，金融/能源语境）③展览（exposición de arte 艺术展）。语境义：本文取\u201C风险敞口\u201D这一专业义，指电力系统面临电价上涨风险的程度。DELE B2 常考其多义辨析，需结合上下文判断。易混淆词：exposición（暴露/展览）vs explosión（爆炸，词形相近）。" },
      { w: "descarbonización", m: "脱碳", ejemplo: "retrasa la descarbonización real basada en renovables.", analisis: "由前缀 des-（去除）+ carbono（碳）+ 后缀 -ización（……化）构成，指\u201C减少碳排放、摆脱对碳基能源依赖的过程\u201D。常见搭配 descarbonización de la economía（经济脱碳）、proceso de descarbonización（脱碳进程）、objetivos de descarbonización（脱碳目标）。这是气候变化领域的学术词汇。语境义：本文指通过发展可再生能源实现\u201C真正\u201D的脱碳。DELE B2 学术阅读中高频出现，常与 transición energética（能源转型）、neutralidad climática（气候中和）配套考查。" },
      { w: "apagón", m: "停电；大停电", ejemplo: "un apagón masivo sin precedentes... reavivaron el debate.", analisis: "由动词 apagar（关、熄灭）+ 增义后缀 -ón 构成，-ón 在此表\u201C突然、强烈\u201D的意味。常见搭配 apagón eléctrico（停电）、apagón masivo/general（大规模停电）、sufrir un apagón（遭遇停电）。语法上为阳性名词。语境义：本文指\u201C去年史无前例的大规模停电\u201D这一具体事件，是引发核电辩论的导火索。易混淆词：apagón（停电）vs corte（中断/断电，更口语）vs avería（故障）。DELE B2 时事阅读中常见。" },
      { w: "coalición", m: "联盟；联合政府", ejemplo: "Sumar, el socio menor de la coalición de Gobierno, la criticó.", analisis: "源自拉丁语 coalitio（联合），由 co-（共同）+ alere（滋养、生长）演变而来，指\u201C政党或团体为共同目标组成的联盟\u201D。常见搭配 coalición de Gobierno（执政联盟）、formar una coalición（组建联盟）、socio de coalición（联盟伙伴）。语法上为阴性名词。语境义：本文指西班牙执政的左翼联合政府，其中苏马尔党是小党。DELE B2 政治语篇常考，需辨析 coalición（联盟）vs alianza（同盟，更宽泛）vs pacto（协议）。" },
      { w: "viabilidad", m: "可行性；可持续性", ejemplo: "El equilibrio entre seguridad energética, descarbonización y viabilidad económica...", analisis: "源自拉丁语 via（道路）+ 形容词后缀 -bilis，本义\u201C可通行的\u201D，引申为\u201C可行的、可维持的\u201D。常见搭配 viabilidad económica（经济可行性）、viabilidad técnica（技术可行性）、estudiar la viabilidad（研究可行性）。语法上为阴性名词，形容词形式为 viable（可行的）。语境义：本文指核能延期在经济上是否\u201C划算、可持续\u201D。DELE B2 议论文写作高频词，常与 factible、sostenible 辨析：viable 侧重\u201C可行\u201D，sostenible 侧重\u201C可持续\u201D。" },
      { w: "reavivar", m: "重新点燃；再度激起", ejemplo: "un apagón masivo... y la subida de los precios... reavivaron el debate.", analisis: "由前缀 re-（再次）+ avivar（点燃、使活跃）构成，指\u201C使已沉寂的事物重新活跃起来\u201D。常见搭配 reavivar el debate（重新点燃辩论）、reavivar la polémica（再度引发争议）、reavivar el interés（重燃兴趣）。语法上为规则 -ar 动词。语境义：本文指停电和涨价\u201C重新引发了\u201D关于核电关停的辩论。易混淆词：reavivar（重新激起）vs revivir（复活、重现）vs renovar（更新）。" },
      { w: "mitigar", m: "减轻；缓和", ejemplo: "la prórroga... mitiga la exposición del sistema eléctrico.", analisis: "源自拉丁语 mitigare（使柔和），词根 mitis（温和的）。常见搭配 mitigar el impacto（减轻影响）、mitigar los efectos（缓解后果）、mitigar el riesgo（降低风险）。语法上为规则 -ar 动词，其名词形式为 mitigación（缓解）。语境义：本文指延期\u201C减轻\u201D了电力系统面临电价上涨的风险。DELE B2 常考其与 reducir（减少）、aliviar（缓解）的辨析：mitigar 更正式，多用于书面语。" },
      { w: "impensado", m: "未预料到的；意外的", ejemplo: "a subidas de precios imprevistas.", analisis: "（注：原文用 imprevistas）源自拉丁语 improvisus，由 in-（否定）+ providere（预见）构成，形容词形式为 imprevisto/previsto，本义\u201C没有预先看到的\u201D。常见搭配 subida imprevista（意外上涨）、gasto imprevisto（意外开支）、situación imprevista（意外情况）。语法上 imprevisto 的阴性为 imprevista。语境义：本文指\u201C不可预见的电价上涨\u201D。易混淆词：imprevisto（意外的）vs improvisado（即兴的、临时拼凑的）vs imprevisible（无法预测的）。" },
      { w: "despoblada", m: "人口稀少的；荒芜的", ejemplo: "en la Extremadura rural y despoblada.", analisis: "由前缀 des-（去除、否定）+ poblada（有人居住的，源自 poblar\u201C使有人居住\u201D）构成，指\u201C人口稀少、居民流失\u201D。常见搭配 zona despoblada（人口稀少地区）、España despoblada（西班牙空心化地区）、despoblación rural（农村人口流失）。语境义：本文指埃斯特雷马杜拉农村地区\u201C人口流失严重\u201D。DELE B2 社会议题高频词，常与 la España vaciada（\u201C被掏空的西班牙\u201D，指人口外流的农村地区）这一时事概念配套考查。" }
    ],
    quiz: [
      { q: "¿En qué año estaba previsto cerrar la central nuclear de Almaraz?", opts: ["En 2030.", "En 2028.", "En 2035.", "En 2026."], ans: 1, es: "El texto dice (párrafo 2) que Almaraz \u201Cestaba prevista para cerrar en 2028\u201D.", zh: "原文第 2 段说阿尔马拉斯\u201C原定于 2028 年关闭\u201D，故选 B。此题考查直接定位。" },
      { q: "Según el artículo, ¿cuál fue el detonante directo que llevó al Gobierno a reconsiderar el cierre nuclear?", opts: ["Una exigencia de la Unión Europea.", "El apagón masivo del año pasado y la subida de precios causada por la guerra en Oriente Medio.", "La presión de las empresas.", "El cambio climático."], ans: 1, es: "El párrafo 4 señala que \u201Cun apagón masivo... y la subida de los precios... reavivaron el debate\u201D. Hay que entender reavivar（重新点燃）como indicio causal para deducir que el apagón y la subida de precios fueron el detonante.", zh: "第 4 段指出\u201C大规模停电……和能源价格上涨……重新点燃了辩论\u201D。需理解 reavivar（重新点燃）所暗示的因果关系，推断出停电与涨价是导火索，故选 B。此题考查因果推理。" },
      { q: "¿Cuál es la crítica central de Sumar a la decisión de prorrogar Almaraz?", opts: ["Que la prórroga es demasiado corta.", "Que se basa en presión empresarial y no en razones técnicas, ambientales o económicas, y que retrasa la descarbonización real.", "Que la central es demasiado antigua.", "Que deberían cerrarse más centrales pero conservar Almaraz."], ans: 1, es: "Hay que distinguir las posturas de distintos actores: los párrafos 10-11 muestran que Sumar cree que la decisión se basa en \u201Cpresión empresarial\u201D y que \u201Cretrasa la descarbonización real\u201D. Es un ejercicio de discernimiento del contraargumento.", zh: "需区分不同主体的观点：第 10-11 段明确指出苏马尔党认为决定基于\u201C企业施压\u201D、会\u201C推迟真正的脱碳\u201D。这是对反方（政府）论点的辨析，故选 B。此题考查观点辨析。" },
      { q: "¿Cuál es la razón principal que el Gobierno dio para justificar la prórroga?", opts: ["Que la central genera más beneficios.", "Que una prórroga limitada mitiga la exposición del sistema y de los consumidores a subidas de precios imprevistas.", "Que la central no tiene ningún riesgo.", "Para complacer a las empresas."], ans: 1, es: "La cita oficial del párrafo 6 \u201Cmitiga la exposición del sistema eléctrico y de los consumidores a subidas de precios imprevistas\u201D es una oración compleja con léxico técnico (exposición, imprevistas), cuyo sentido completo hay que desentrañar.", zh: "第 6 段官方引语\u201C减轻电力系统和消费者面临不可预见电价上涨的风险敞口\u201D是含专业词 exposición、imprevistas 的复合句，需完整理解其语义才能作答，故选 B。此题考查长句理解与词汇深度。" },
      { q: "¿En qué aspectos es importante la central de Almaraz para Extremadura?", opts: ["Aporta cerca del 7% de la electricidad nacional y es clave para la industria y el empleo rural.", "Es la única atracción turística de la región.", "Solo genera empleo.", "Solo produce electricidad, sin otro efecto."], ans: 0, es: "El párrafo 14 señala que \u201Caporta alrededor del 7% de la producción eléctrica\u201D y que \u201Ces una fuente clave de industria y empleo\u201D.", zh: "第 14 段指出\u201C贡献约 7% 的电力生产\u201D且\u201C是产业和就业的关键来源\u201D，故选 A。此题考查直接定位。" },
      { q: "¿Qué actitud mostró la presidenta regional María Guardiola ante la prórroga?", opts: ["De oposición.", "De bienvenida, porque aporta certeza y protege la actividad local.", "Neutral.", "No se pronunció."], ans: 1, es: "El párrafo 15 dice que ella \u201Ccelebró la decisión\u201D y la calificó de \u201Cuna decisión que aporta certeza\u201D.", zh: "第 15 段说她\u201C对这一决定表示欢迎\u201D，称其\u201C带来确定性\u201D，故选 B。此题考查直接定位。" },
      { q: "Según el final del artículo, ¿de qué es, en esencia, una prueba la prórroga de Almaraz?", opts: ["De si la central es segura.", "De si es posible combinar la urgencia climática con un suministro eléctrico estable y asequible.", "De si el Gobierno es popular.", "De si las empresas pueden obtener beneficios."], ans: 1, es: "Hay que integrar los párrafos 19 y 20: el 19 plantea el \u201Cequilibrio entre seguridad energética, descarbonización y viabilidad económica\u201D como dilema complejo, y el 20 concluye que la prórroga es una prueba de \u201Ccombinar la urgencia climática con... un suministro estable y asequible\u201D.", zh: "需综合第 19、20 段：第 19 段提出\u201C能源安全、脱碳与经济可行性之间的平衡\u201D是复杂难题，第 20 段总结延期是考验\u201C能否将气候紧迫性与稳定、可负担的电力供应结合起来\u201D。整合两段才能得出完整答案，故选 B。此题考查跨段落综合。" },
      { q: "¿Qué actitud general del autor hacia la prórroga nuclear en España se puede inferir del conjunto del texto?", opts: ["Apoya plenamente al Gobierno.", "Presenta de forma objetiva la controversia entre múltiples partes y la sitúa como un dilema general de la transición energética europea.", "Se opone firmemente a la energía nuclear.", "Solo le interesan los beneficios empresariales."], ans: 1, es: "El texto presenta con objetividad las posturas del Gobierno, Sumar, la presidenta regional y las empresas (párrafos 6-15), y al final lo eleva a un \u201Cgiro más amplio en Europa\u201D (párrafo 16) y a \u201Cuno de los dilemas más complejos de la política europea\u201D (párrafo 19), sin tomar partido explícito.", zh: "全文客观呈现政府、苏马尔党、地区领导人、企业等多方观点（第 6-15 段），并在结尾将其上升为\u201C欧洲更广泛的转向\u201D（第 16 段）和\u201C当代欧洲政治最复杂的难题\u201D（第 19 段），未明确站队。综合推断，作者态度是客观呈现争议，故选 B。此题考查作者态度推断与观点辨析。" }
    ]
  }
};
